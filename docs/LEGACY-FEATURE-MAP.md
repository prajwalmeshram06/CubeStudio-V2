...
|---|---|---|---|
| 3D Simulator | Monolithic script / Three.js coupling | Pure CubeState -> Three.js Presentation Adapter (`src/cube/rendering/`) | Planned (Phase 1) |
| Cube State Logic | Scattered in UI/Renderer | Pure Cube Engine (`src/cube/model/` & `src/cube/engine/`) | In Progress (Phase 0) |
